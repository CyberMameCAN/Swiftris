...
//        scene.redrawShape(shape: swiftris.fallingShape!, completion: {})
    ...
    func gameDidEnd(swiftris: Swiftris) {
        ...
        scene.playSound(sound: "Blocs/Sounds/gameover.mp3")
    ...
    func gameDidLevelUp(swiftris: Swiftris) {
        ...
        scene.playSound(sound: "Blocs/Sounds/levelup.mp3")
    }
    ...
    func gameShapeDidDrop(swiftris: Swiftris) {
        ...
        scene.playSound(sound: "Blocs/Sounds/drop.mp3")
    }
...
//        nextShape()
        ...
        if removedLines.linesRemoved.count > 0 {
            ...
            scene.playSound(sound: "Blocs/Sounds/bomb.mp3")
        } else {
            nextShape()
        }
